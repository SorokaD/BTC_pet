...
load_models(["predict_default_amounts"])
...
def test_default_amounts_positive(local_fastapi_client, url: str, data: Dict[str, Any]) -> None:
    ...
    assert type(response_body["presets"]) is dict
